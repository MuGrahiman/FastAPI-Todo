...
from urllib.parse import quote_plus # used to URL Encoding
...
QUERY = os.environ.get('MONGO_QUERY')
QUSERNAME = quote_plus(USERNAME)
QPASSWORD = quote_plus(PASSWORD)
MONGODB_URI = f"mongodb+srv://{QUSERNAME}:{QPASSWORD}@{HOST}/{DATABASE}?{QUERY}"
